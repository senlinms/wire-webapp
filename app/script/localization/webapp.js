...
z.string.preferences_options_calling = 'Calling';
z.string.preferences_options_calling_vbr_checkbox = 'Variable Bit Rate Encoding';
z.string.preferences_options_calling_vbr_detail = 'This makes audio calls use less data and work better on slower networks. Turn off to use Constant Bitrate Encoding.';
